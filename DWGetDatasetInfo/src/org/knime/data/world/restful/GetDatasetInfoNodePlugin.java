 ...
 */
public class GetDatasetInfoNodePlugin extends Plugin {
    // The shared instance.
    private static GetDatasetInfoNodePlugin plugin;

    /**
     * The constructor.
     */
    public GetDatasetInfoNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GetDatasetInfoNodePlugin getDefault() {
        return plugin;
    }
