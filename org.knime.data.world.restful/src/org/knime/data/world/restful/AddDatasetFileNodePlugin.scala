 ...
 */
class AddDatasetFileNodePlugin extends Plugin {

  AddDatasetFileNodePlugin.plugin = this  // Set the shared instance to this instance
  ...
  override def stop(context : BundleContext) : Unit = {
    super.stop(context)
    AddDatasetFileNodePlugin.plugin = null
  }
  
  
}

object AddDatasetFileNodePlugin {
  // The shared plugin instance.
  private var plugin : AddDatasetFileNodePlugin = null
   ...
   */
  def getDefault() : AddDatasetFileNodePlugin = plugin
}
